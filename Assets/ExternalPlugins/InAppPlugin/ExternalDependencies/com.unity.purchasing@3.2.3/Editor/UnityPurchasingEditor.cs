...
namespace UnityEditor.Purchasing {
    ...
    public static class UnityPurchasingEditor
    {
        ...
        private const string BinPath = "Plugins/UnityPurchasing/Android";
        ...
        {
            string binPathWithRoot = UnityIapPluginHierarchy.Instance.GetPathWithRoot(BinPath);
            foreach (var mapping in StoreSpecificFiles) {
                ...
                string path = string.Format("{0}/{1}", binPathWithRoot, mapping.Key);
