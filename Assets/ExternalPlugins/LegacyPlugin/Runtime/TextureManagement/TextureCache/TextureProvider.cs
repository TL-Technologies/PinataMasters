...
namespace Modules.Legacy.TextureManagement.TextureCache
{
	...
	public abstract class TextureProvider
	{
		...
		{
			get { return state == TextureState.Loaded; }
		}


		public bool InProgress
		{
			get { return state == TextureState.Loading; }
		}


		public abstract Texture2D Load(string path, TextureFormat format, bool mipmaps);

		public abstract void LoadAsync(string path, TextureFormat format, bool mipmaps,
