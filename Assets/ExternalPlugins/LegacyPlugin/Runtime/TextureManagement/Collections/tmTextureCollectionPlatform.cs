...
using Modules.Legacy.TextureManagement.TextureCache;
...
namespace Modules.Legacy.TextureManagement.Collections
{
    public class tmTextureCollectionPlatform : tmTextureCollectionBase
    {
        ...
        public static tmTextureCollectionPlatform operator +(tmTextureCollectionPlatform platform,
        ...
        public void LoadTexture()
        {
            ...
            if (atlas == null)
            {
                ...
                {
                    atlas = TextureCache.TextureCache.LoadTexture(path,
                        useStreamingAssets ? TextureDataSource.StreamingAssets : TextureDataSource.Resources,
                        importSettings.format, importSettings.generateMipMaps);
                ...
                {
                    TextureCache.TextureCache.LoadTextureAsync(path,
                        useStreamingAssets ? TextureDataSource.StreamingAssets : TextureDataSource.Resources,
                        importSettings.format, importSettings.generateMipMaps, TextureDidLoaded);
                }
            }
        }
            ...
            {
                {
                    ...
                    atlas = null;
                    TextureCache.TextureCache.UnloadTexture(assetPath);
                    unloading = null;
                }
            }
        }
