...
public class tk2dSpriteCollection : MonoBehaviour 
{
    ...
    public bool enablePlatformScaleVertex = false;
    ...
    public int[] atlasWidthTexture = new int[0];
    public int[] atlasHeightTexture = new int[0];
