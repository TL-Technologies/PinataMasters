    ...
    public override void OnInspectorGUI()
    {
		...
		else
		{
			...
			else
			{
					...
					string message =
						@"Due to changes in the prefab system in Unity 2018.3, the edit functionality has been moved." +
						"Exit prefab edit mode, select your sprite collection and click 2D Toolkit / Edit... in the main menu";
				...
				{
					#if UNITY_2018_3_OR_NEWER
						EditorUtility.DisplayDialog("Open Editor has moved",
							message,
							"Ok");
					#else
