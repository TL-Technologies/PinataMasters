...
namespace tk2dEditor.SpriteCollectionEditor
{
	...
	public class SpriteCollectionProxy
	{
		...
		public void ClearReferences() {
			...
			atlasTextureFiles = new TextAsset[0];
            atlasTexturePaths = new string[0];
            atlasWidthTexture = new int[0];
            atlasHeightTexture = new int[0];
            ...
            obj.atlasWidthTexture = new int[0];
            obj.atlasHeightTexture = new int[0];
        ...
        public bool enablePlatformScaleVertex;
        ...
        public int[] atlasWidthTexture;
        public int[] atlasHeightTexture;
        ...
        public bool asyncLoadEnabled = false;
