...
public class tk2dSlicedSpriteEditor : tk2dSpriteEditor
{
	...
	public override void OnInspectorGUI()
	{
		...
		var spriteData = sprite.CurrentSprite;
		if (spriteData == null) {
			return;
		}
		...
		else
		{
			...
			{
				tk2dUndo.RecordObjects(targetSlicedSprites, "Sliced Sprite BorderLeft");
//				foreach (tk2dSlicedSprite spr in targetSlicedSprites) spr.Collection.spriteDefinitions[spr.spriteId].borderLeft = newBorderLeft;
			}
			...
			{
				tk2dUndo.RecordObjects(targetSlicedSprites, "Sliced Sprite BorderRight");
//				foreach (tk2dSlicedSprite spr in targetSlicedSprites) spr.Collection.spriteDefinitions[spr.spriteId].borderRight = newBorderRight;
			}
			...
			{
				tk2dUndo.RecordObjects(targetSlicedSprites, "Sliced Sprite BorderTop");
//				foreach (tk2dSlicedSprite spr in targetSlicedSprites) spr.Collection.spriteDefinitions[spr.spriteId].borderTop = newBorderTop;
			}
			...
			{
				tk2dUndo.RecordObjects(targetSlicedSprites, "Sliced Sprite BorderBottom");
//				foreach (tk2dSlicedSprite spr in targetSlicedSprites) spr.Collection.spriteDefinitions[spr.spriteId].borderBottom = newBorderBottom;
			}
