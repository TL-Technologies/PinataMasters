...
namespace Modules.Legacy.TextureManagement.Editor.Inspectors
{
	...
	public class tmBatchObjectEditor : UnityEditor.Editor
	{
		tmBatchingType[] toggleTypes =
			{tmBatchingType.None, tmBatchingType.Dynamic, tmBatchingType.Static, tmBatchingType.Skinning};
