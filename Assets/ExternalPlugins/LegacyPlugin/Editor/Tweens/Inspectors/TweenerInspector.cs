...
namespace Modules.Legacy.Tweens.Editor
{
    public abstract class TweenerInspector : UnityEditor.Editor
    {
        ...
        override public void OnInspectorGUI()
        {
            ...
            EditorGUILayout.EndHorizontal();
            LegacyEditorTools.DrawInvokeData(tween.invokeWhenFinished);
